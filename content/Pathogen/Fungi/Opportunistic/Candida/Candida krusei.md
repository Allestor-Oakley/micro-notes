...
target_organs:
  ...
  - Eyes
dimorphic_status:
  - Monomorphic (Exists as budding yeasts, pseudohyphae, and true hyphae in both saprobic and parasitic phases)
yeast_features:
  - Oval yeastlike forms (2-6 μm in diameter)
  - Reproduces by formation of buds (blastoconidia)
mold_features:
  - Produces pseudohyphae and true hyphae
hyphae_type:
...
*   **Cell Wall Composition & Membrane:** The cell wall contains mannans, 1,3-beta-D-glucan, and chitin. The cell membrane contains ergosterol as its major sterol component.
*   **Thermal Dimorphism & Environmental Triggers:** Not thermally dimorphic; the saprobic and parasitic phases are identical. Exhibits a bud-hyphae transition.
*   **Microscopic Morphology (Yeast Form):** Oval budding yeasts, 2 to 6 μm in diameter. Reproduces by the formation of blastoconidia (buds).
*   **Microscopic Morphology (Mold / Hyphal Form):** Produces pseudohyphae and true hyphae.
*   **Macroscopic & Colony Morphology:** Variable morphology; colonies are usually pasty, white to tan, and opaque. May have a smooth or wrinkled morphology.
...
*   **Secondary, Atypical & Alternate Presentations:** Endocarditis, pericarditis, meningitis, brain abscesses, cystitis, pyelonephritis, endophthalmitis, hepatosplenic candidiasis, peritonitis, and visceral abscesses.
*   **Disseminated Disease:** Hematogenous dissemination and candidemia (bloodstream infections) with a high propensity to seed deep tissues of target organs. While *C. krusei* causes about 2.5% of candidemia cases overall, it is disproportionately responsible for severe bloodstream infections in specific high-risk cohorts: 16.0% of isolates in hematologic malignancy patients and 19.4% in stem cell transplant recipients.
*   **Opportunistic Presentations:** Frequent cause of central line-associated bloodstream infections in intensive care units (ICUs) and among highly debilitated hospitalized patients.
...
*   **Wet Mounts:** N/A
*   **Culture Media & Growth Speed:** Can be isolated using standard fungal media or CHROMagar.
