...
clinical_syndromes:
  ...
  - Inflammatory bowel disease (IBD) / IBS mimic
endemic_regions:
  - Worldwide
target_organs:
  - Large intestine (colon lumen, cecum)
protozoa_class: Parabasala (Trichomonadea / Metamonada)
locomotion_type: Pseudopodia (broad, leaf-like, or triangular pseudopodia with serrated margins; lacks external flagella)
infective_stage: Cyst (fecal-oral) and potential transmission inside Enterobius vermicularis eggs
diagnostic_stage: Trophozoite (binucleate/mononucleate) and Cyst
date: 2026-07-29
draft: false
---
...
*   **Intracellular Morphologies:** N/A. *Dientamoeba fragilis* is an extracellular, lumen-dwelling parasite that colonizes mucosal surfaces without invading intracellular mucosal compartments.
*   **Locomotion Mechanics:** Active motility in fresh wet mounts is accomplished via rapid extension of broad, leaf-like, or triangular hyaline pseudopodia with characteristically serrated or pointed margins. Motility is nonprogressive or moderately directional. Trophozoites are extremely fragile and rapidly lyse/disintegrate in water or unpreserved liquid stool specimens.
...
*   **Acute Clinical Presentation:** Ranging from asymptomatic carriage to acute enteritis. Symptoms include sudden onset of watery or loose diarrhea, abdominal pain, stomach cramps, nausea, vomiting, flatulence, bloating, low-grade fever, and acute gastrointestinal distress.
*   **Chronic & Extra-Intestinal Disease:**
    - Chronic Dientamoebiasis: Persistent or intermittent loose stools, chronic abdominal pain, recurrent flatulence, anorexia, weight loss, failure to thrive/poor weight gain in children, malaise, and chronic fatigue lasting for months to years if untreated.
    - Inflammatory Bowel Disease (IBD) / IBS Mimic: Elevated fecal calprotectin and chronic symptoms frequently masquerade as post-infectious Irritable Bowel Syndrome (IBS) or Inflammatory Bowel Disease (IBD).
    - Extraintestinal Complications: N/A (non-invasive organism).
*   **Pathognomonic Signs:** Microscopic identification of binucleate ameboid trophozoites (5–18 µm) in permanent stained stool smears displaying 2 nuclei with karyosomes fragmented into 4 to 8 discrete chromatic granules and lacking peripheral nuclear chromatin.
*   **Host Immune Response & Laboratory Findings:**
    - Stool Examination: Positive for *D. fragilis* trophozoites and/or cysts. Fecal calprotectin levels are frequently elevated. Stool occult blood is negative; Charcot-Leyden crystals are occasionally present.
...
*   **Microscopy & Stains:**
    - Direct Saline Wet Mount: UNRELIABLE and NOT RECOMMENDED as a primary diagnostic method. Trophozoites lack external flagella, move via pale pseudopodia, and rapidly degenerate/lyse in unpreserved stool or saline wet preparations. Cysts are difficult to recognize on wet mounts.
    - Permanent Stained Smears (Wheatley's Trichrome / Iron Hematoxylin - MANDATORY GOLD STANDARD): Diagnostic method of choice. Visualizes binucleate (60–80%) and mononucleate (20–40%) trophozoites (5–18 µm). Cytoplasm stains pale blue-green to purple with granular inclusions. Nuclei display 4 to 8 dark red/purple to black chromatic granules without peripheral nuclear membrane chromatin. Cysts (5–8 µm) appear shrunken with a clear halo surrounding two cyst walls.
    - SPECIMEN FIXATION REQUIREMENT: Fecal specimens MUST be preserved immediately upon collection in fixatives (PVA, SAF, Formalin, or TOTAL-FIX) because *D. fragilis* trophozoites disintegrate rapidly in unpreserved stool. Minimum of three separate stool specimens collected on alternate days should be examined.
*   **Concentration & Stool O&P Techniques:**
    - Formalin-Ethyl Acetate Sedimentation Concentration: Cysts can be concentrated from preserved stool; however, trophozoites are destroyed during routine concentration steps, reinforcing the mandatory requirement for permanent stained smears.
    - In Vitro Culture: Cultured in xenic or axenic media (TYSGM-9, Boeck and Drbohlav's LES, TYI-S-33). Culture increases recovery sensitivity for molecular and isoenzyme characterization.
*   **Serology & Rapid Antigen Tests:**
    - Serum Antibody Detection: Indirect Immunofluorescence Assays (IFA) detect anti-*D. fragilis* serum antibodies (positive titers ≥1:10 to 1:80). Immunoblotting/Western blot identifies a diagnostic 39-kDa immunodominant protein antigen. Commercial rapid antigen detection kits are not routinely available.
*   **Molecular Diagnostics:**
    - Polymerase Chain Reaction (PCR): Real-time PCR and multiplex tandem PCR (MT-PCR) targeting small subunit (18S) rRNA gene sequences offer exquisite sensitivity (>92–100%) and specificity (100%).
    - Commercial Multiplex Molecular Panels: Included in multiplex molecular enteric panels (e.g., RIDAGENE Stool Panel, EasyScreen Enteric Parasite Detection Kit) for rapid syndromic detection directly from unpreserved fresh/frozen stool or Cary-Blair media.
