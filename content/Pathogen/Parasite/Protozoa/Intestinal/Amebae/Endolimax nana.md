...
*   **Trophozoite Stage Features:** Uninucleate small amebic form measuring 6 to 15 µm in diameter (usual range 6 to 12 µm or 8 to 10 µm; on permanent stained smears, artificial shrinkage due to dehydration causes organisms to measure 1 to 2 µm smaller). Contains a single nucleus that is usually not visible in unstained wet mount preparations. The nuclear membrane characteristically lacks peripheral chromatin (or possesses minimal, extremely fine peripheral chromatin). The karyosome is large, prominent, dark, dense, irregular, or clumped ("blot-like" karyosome), and is often centrally or eccentrically placed, sometimes split into several dark masses connected by fine strands. The cytoplasm is finely granular, vacuolated, and contains ingested bacteria and cellular debris within food vacuoles, but host red blood cells (RBCs) are strictly absent. Lacks functional mitochondria (amitochondrial protist with reduced nonaerobic mitochondria).
*   **Cyst / Oocyst Stage Features:** Small spherical, oval, or characteristically ellipsoidal/oval hyaline cyst measuring 5 to 14 µm in diameter (usual range 5 to 10 µm or 6 to 8 µm; shrinks slightly on permanent stained smears). Enclosed by a thin, smooth refractive cyst wall. Immature cysts contain 1 or 2 nuclei; mature cysts (metacysts) contain four small nuclei (quadrinucleated cyst). The four nuclei are often localized towards one end or arranged in pairs, displaying small, dot-like or blot-like karyosomes without peripheral chromatin. Chromatoidal bodies/bars are typically absent (or rarely present as small, indistinct granules or rods). In immature cysts, glycogen masses may be present and stain reddish-brown with iodine.
*   **Intracellular Morphologies:** N/A
*   **Locomotion Mechanics:** Motility in direct wet mounts of fresh, unpreserved stool is sluggish, nonprogressive, and nondirectional. Movement is accomplished via the slow extrusion of short, blunt, hyaline pseudopodia.

#### Lifecycle & Transmission
*   **Definitive Host:** Humans serve as the principal natural host and reservoir. Also found in non-human animals (such as primates).
*   **Intermediate Host & Vector Dynamics:** None required. Filth flies and cockroaches can act as mechanical transport vectors.
*   **Transmission Route:** Fecal-oral route through ingestion of infective cysts present in fecally contaminated drinking water, ice, or raw food, or direct person-to-person transmission via contaminated hands, fomites, or unhygienic food handling.
*   **Infective Stage & Portal of Entry:** Ingestion of mature quadrinucleated cysts via the mouth into the gastrointestinal tract. Cysts pass unaltered through stomach acidity and undergo excystation in the small intestine to release metacystic amebae that colonize the lumen of the large intestine.
*   **Diagnostic Stage & Specimen Source:** Both trophozoites and cysts are passed in stool and recovered in diagnostic clinical specimens. Specimen source is human stool (feces).
...
*   **Pathognomonic Signs:** Microscopic identification of small oval/ellipsoidal cysts (5–10 µm) containing 4 small nuclei with blot-like karyosomes and no peripheral chromatin, and/or small trophozoites (6–12 µm) with a single nucleus featuring a large, prominent, blot-like karyosome lacking peripheral nuclear chromatin on permanent stained smears.
...
*   **Buzzwords & Descriptors:**
    - "Dwarf ameba" / "Small nonpathogenic ameba" (distinguished as a separate ameba around 1908).
    - "Large, blot-like / irregular karyosome lacking peripheral nuclear chromatin".
    - "Small oval / ellipsoidal cyst with 4 nuclei".
