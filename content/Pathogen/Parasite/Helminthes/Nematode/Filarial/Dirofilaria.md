...
body_shape: Long, slender, cylindrical roundworm with thick cuticle and longitudinal ridges (subgenus Nochtiella) or smooth cuticle (D. immitis)
infective_stage: Third-stage infective larva (L3)
diagnostic_stage: Nongravid immature adult worm in tissue biopsy / surgical specimen
host_definitive: Dogs, wild canids, raccoons, bears, wolves, cats, and other carnivores
host_intermediate_1: Mosquitoes (Culex species, Aedes species, Anopheles species)
host_intermediate_2:
  - N/A
date: 2026-07-29
draft: false
...
*   **Adult Worm Morphology & Attachment Structures:**
    - Size & Dimensions: Slender, thread-like filarial roundworms. Adult female *Dirofilaria immitis* measure 230 to 310 mm in length; adult male *D. immitis* measure 120 to 190 mm in length. Subcutaneous species (subgenus *Nochtiella*, including *D. repens*, *D. tenuis*, *D. ursi*, *D. striata*, *D. subdermata*) are generally smaller (typically 50 to 170 mm in length).
    - Cuticular Anatomy (Key Taxonomic Feature):
      - *Dirofilaria immitis*: Possesses a relatively smooth, thick, multi-layered cuticle lacking prominent external longitudinal ridges.
      - Subgenus *Nochtiella* (*D. repens*, *D. tenuis*, *D. ursi*, *D. striata*, *D. subdermata*): Characterized by a thick, laminated cuticle displaying prominent, regularly spaced longitudinal ridges/striations and cuticular laminations running along the body wall.
    - Internal Cross-Sectional Histology: Histological sections reveal broad lateral chords, large polymyarian/coelomyarian muscle cells lining the pseudocoelom, a prominent intestine, and paired uterine tubes or male copulatory structures.
    - Sexual Immaturity in Humans: Almost all *Dirofilaria* adult worms isolated from human tissue lesions are sexually immature, stunted, non-gravid, and degenerating. (Gravid adult worms in humans are extremely rare, reported almost exclusively in severely immunodeficient individuals).
    - Endosymbiont Presence: Harbors intracellular bacterial endosymbionts belonging to the genus *Wolbachia* within its tissues, which play a role in parasite survival and host inflammatory responses.
*   **Ova / Egg Microscopic Features:**
    - Ovoviviparous Reproduction: Adult female worms in natural definitive hosts produce microfilariae rather than depositing thick-shelled eggs. Ova/eggs are NOT observed in human clinical specimens because female worms do not mature to gravid egg-producing status in human dead-end hosts.
...
*   **Tissue Invasion & Structural Damage:**
    - Embolization & Pulmonary Infarction (*D. immitis*): Immature adult worm arriving in a terminal pulmonary artery cannot survive, dies, and acts as an embolus. This triggers localized endarteritis, vessel thrombosis, local pulmonary tissue ischemic necrosis, hemorrhagic infarction, and dense peripheral fibrous granuloma formation surrounding the dead parasite.
    - Subcutaneous & Ocular Nodule Formation (*D. repens* / *D. tenuis*): Dead or dying immature worms in deep connective tissue, subcutaneous skin layers, or conjunctiva elicit a localized foreign-body reaction, granulomatous inflammation, focal necrosis, and fibrous capsule formation.
*   **Mechanical Obstruction:**
    - Vascular Occlusion: Mechanical blockage of small-to-medium-sized pulmonary arterial branches by the body of the dying worm, leading to localized pulmonary focal necrosis. In heavy canine infections, *D. immitis* clogs the right ventricle and pulmonary trunk, but this right-heart obstruction does NOT occur in humans.
...
*   **Acute Migration Phase Presentation:**
    - Initial larval injection and early tissue migration are clinically silent and asymptomatic.
*   **Chronic Intestinal or Tissue Presentation:**
    - Pulmonary Dirofilariasis (*D. immitis*):
      - Asymptomatic Coin Lesion (Most Common Presentation): Over 50–90% of human pulmonary cases are completely asymptomatic and discovered incidentally on routine chest radiograph or CT scan as a solitary, well-demarcated, spherical, non-calcified "coin lesion" (1 to 3 cm in diameter), frequently misdiagnosed as primary lung carcinoma, solitary metastatic tumor, or tuberculoma.
      - Symptomatic Pulmonary Disease: When symptomatic, patients present with localized pleuritic chest pain, chronic dry cough, mild hemoptysis, low-grade fever, chills, dyspnea, malaise, and occasional pleural effusion.
    - Subcutaneous & Ocular Dirofilariasis (*D. repens*, *D. tenuis*, *D. ursi*):
      - Subcutaneous Lesions: Painless or mildly tender, firm, mobile, slowly enlarging subcutaneous nodules or soft tissue swellings on the chest wall, abdominal wall, face, eyelids, extremities, scrotum, or male genitalia.
      - Ocular / Conjunctival Lesions: Subconjunctival nodules, orbital masses, or ocular migration causing sensation of a foreign body in the eye, conjunctival hyperemia, eye pain, periorbital edema, excessive lacrimation, and visual disturbances.
*   **Pathognomonic Signs:**
    - Solitary, smooth, well-circumscribed, peripheral "coin lesion" in lung parenchyma on chest radiograph or CT scan in an asymptomatic individual with dog exposure.
    - Microscopic detection of cross-sections of a roundworm inside a thrombosed pulmonary artery or subcutaneous granuloma displaying a thick cuticle with regularly spaced longitudinal ridges (subgenus *Nochtiella*) or smooth multi-layered cuticle (*D. immitis*), polymyarian muscle cells, and internal intestinal/reproductive structures.
*   **Eosinophilia Profile & IgE Response:**
    - Peripheral blood eosinophilia is UNCOMMON or low-grade (<10–15%) in most patients with solitary localized nodules; total serum IgE levels may be modestly elevated.
...
*   **Stool Ova & Parasite Examination:**
    - Human Stool Examination: ALWAYS negative and non-diagnostic. *Dirofilaria* is a tissue and vascular parasite with no gastrointestinal stage.
*   **Sedimentation & Flotation Concentration Techniques:**
    - Stool Concentration: N/A.
    - Blood Concentration Techniques (Knott's / Membrane Filtration): Routine human blood concentration for microfilariae is negative because humans are dead-end hosts and do not develop microfilaremia. (Knott's test is used in veterinary medicine to detect canine *D. immitis* microfilariae).
*   **Serology & Tissue Biopsy Diagnostics:**
    - Histopathology & Surgical Biopsy (Gold Standard for Diagnosis): Definitive diagnosis is almost exclusively established by microscopic examination of resected lung coin lesions, subcutaneous nodules, or ocular biopsy specimens:
      - Demonstrates cross-sections of an immature filarial nematode surrounded by dense granulomatous tissue, palisading epithelioid cells, eosinophils, and fibrous tissue.
      - Key Cuticular Features: Thick laminated cuticle; subgenus *Nochtiella* (*D. repens*, *D. tenuis*) displays prominent regularly spaced longitudinal cuticular ridges, whereas *D. immitis* displays a smooth or finely striated cuticle without prominent longitudinal ridges.
      - Internal Structures: Bilateral lateral chords, coelomyarian/polymyarian musculature, and non-gravid genital tracts.
    - Serological Antibody Detection: Enzyme-Linked Immunosorbent Assay (ELISA) and Indirect Fluorescent Antibody (IFA) tests detecting anti-*Dirofilaria* antibodies exist, but suffer from cross-reactivity with other helminths and lack high sensitivity/specificity; negative serology does NOT rule out localized tissue dirofilariasis.
    - Molecular Diagnostics (PCR): Polymerase Chain Reaction (PCR) and PCR-RFLP targeting ITS1 rRNA or mitochondrial genes (cox1) extracted from fresh or formalin-fixed paraffin-embedded (FFPE) tissue sections provide precise species identification (*D. immitis* vs. *D. repens* vs. *D. tenuis*).
*   **Imaging Findings:**
    - Chest Radiography & Computed Tomography (CT):
      - Reveals a single (rarely multiple), smooth, spherical or ovoid, well-circumscribed, non-calcified, homogeneous subpleural pulmonary nodule ("coin lesion"), typically 1 to 3 cm in diameter, located in lower lung lobes.
      - CT scan demonstrates non-enhancing or minimally enhancing central necrotic core surrounded by a fibrous rim.
    - Soft Tissue Ultrasonography: Subcutaneous or subconjunctival ultrasound visualizes a well-defined hypoechoic nodule containing a coiled, tubular, hyper-reflective serpentine structure representing the worm body.
...
*   **Buzzwords & Descriptors:**
    - "Dog heartworm"
    - "Pulmonary coin lesion mimicking lung cancer / carcinoma"
    - "Thick cuticle with regularly spaced longitudinal ridges (subgenus Nochtiella)"
    - "Nongravid, immature worm trapped in a thrombosed pulmonary artery"
    - "Accidental dead-end human host"
