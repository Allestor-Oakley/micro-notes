...
clinical_syndromes:
  ...
  - Post-treatment filarial encephalopathy
...
body_shape: Slender, thread-like, cylindrical roundworm with bossed cuticle
infective_stage: Third-stage infective larva (L3) / Filariform larva
diagnostic_stage: Sheathed microfilaria in blood (diurnal periodicity); Adult worm extracted from subconjunctiva or skin
host_definitive: Humans
host_intermediate_1: Tabanid deerflies / Red flies (Chrysops silacea, Chrysops dimidiata)
host_intermediate_2:
  - N/A
date: 2026-07-29
draft: false
...
*   **Tissue Invasion & Structural Damage:**
    - Active Subcutaneous Crawling: Adult worms migrate freely through subcutaneous tissues and subconjunctival spaces, causing mechanical tissue displacement and localized irritation.
    - Calabar Swellings (Hypersensitivity Angioedema): Adult worm movement and release of metabolic excretory-secretory products trigger localized, transient, hypersensitivity-mediated subcutaneous angioedema (Calabar swellings), driven by local mast cell degranulation, histamine release, and intense eosinophilic infiltration.
    - Ocular Invasion: Migration across the bulbar subconjunctiva causes acute conjunctival hyperemic inflammation, edema, and exquisite ocular pain.
    - End-Organ Deposition & Microvascular Occlusion: In individuals with high microfilarial densities (>20,000–30,000 mf/mL), microfilariae clog microcapillaries. Deposition of circulating immune complexes triggers chronic filarial glomerulonephritis and endomyocardial fibrosis.
*   **Mechanical Obstruction:**
    - Microvascular Sludging: High concentrations of circulating microfilariae (>30,000/mL) can cause physical sludging and microvascular occlusion in small cerebral, renal, and pulmonary capillaries.
...
*   **Acute Migration Phase Presentation:**
    - Initial larval migration is clinically silent; symptoms begin 6 to 12+ months post-exposure as adults mature.
*   **Chronic Intestinal or Tissue Presentation:**
    - Calabar Swellings (Fugitive / Transient Swellings): The classic hallmark of loiasis. Recurrent, non-pitting, localized subcutaneous angioedema/swellings (measuring 3 to 10+ cm) occurring predominantly on the wrists, forearms, hands, knees, ankles, and periorbital region. Swellings are preceded by localized itching, prickling, or pain, last for 1 to 3 days, and resolve completely as the worm migrates to a new location.
    - Subconjunctival Migration ("Eye Worm"): Migration of a live adult worm under the clear bulbar subconjunctiva of the eye. Causes severe localized eye pain, intense itching, foreign-body sensation, photophobia, lacrimation, eyelid edema, and subconjunctival hyperemia. The worm is visually visible wriggling across the eye for minutes to hours.
    - Complications of High Microfilaremia:
      - Post-Treatment Filarial Encephalopathy: Life-threatening encephalopathy featuring confusion, dysphasia, extrapyramidal signs, seizures, progressive coma, and death following microfilaricidal therapy in patients with high microfilarial burdens (>20,000 mf/mL).
      - Renal Disease: Proteinuria, hematuria, and nephrotic syndrome secondary to immune-complex glomerulonephritis.
      - Cardiac Disease: Endomyocardial fibrosis driven by chronic, severe peripheral eosinophilia.
*   **Pathognomonic Signs:**
    - Direct visual observation or surgical extraction of a live, thin, thread-like adult worm crawling across the subconjunctiva of the eye.
    - Transient, migratory, non-pitting subcutaneous angioedema (Calabar swellings) in an individual with travel or residence in Central/West African rainforests.
    - Sheathed microfilaria in midday blood (10 AM–3 PM) displaying somatic nuclei extending continuously to the extreme tip of the tail.
*   **Eosinophilia Profile & IgE Response:**
    - Marked to extreme peripheral blood eosinophilia (frequently 30% to 70%+; absolute eosinophil count >3,000 to 10,000 cells/μL), particularly pronounced in expatriates and travelers with Calabar swellings. Total serum IgE levels are extraordinarily elevated (>1,000 to 10,000+ IU/mL).
...
*   **Stool Ova & Parasite Examination:**
    - Human Stool Examination: ALWAYS negative and non-diagnostic. *Loa loa* is a tissue and vascular parasite with no gastrointestinal stage.
*   **Sedimentation & Flotation Concentration Techniques:**
    ...
    - Blood Concentration Techniques (Gold Standard for Low Parasitemia):
      - Membrane Filtration (Nuclepore Filter): Passing 1 to 5 mL of daytime blood through a 3-μm or 5-μm polycarbonate filter to trap microfilariae.
      - Knott's Concentration Technique: Mixing 1 mL of midday blood with 9 mL of 2% formalin, centrifuging at 500 x g for 10 minutes, and examining stained sediment under microscopy.
*   **Serology & Tissue Biopsy Diagnostics:**
    - Microscopic Blood Film Examination (Gold Standard): Microscopic examination of thick and thin blood films collected during peak diurnal periodicity (10:00 AM to 3:00 PM). Giemsa or Wright staining confirms sheathed microfilariae (230–250 μm) with nuclei extending continuously to the extreme tail tip.
    - Quantitative Cell-Phone Microscopy (LoaScope): Field-deployable, automated video-microscopy device mounted on a smartphone that rapidly quantifies *Loa loa* microfilarial density in a drop of capillary blood within seconds.
    - Direct Worm Removal: Extirpation of adult worms traversing the subconjunctiva or subcutaneous tissue using small forceps following topical ocular or local local anesthetic application.
    - Serological Antibody Tests: Antifilarial IgG and IgG4 ELISAs detect anti-filarial antibodies, though significant cross-reactivity occurs with *Wuchereria*, *Brugia*, and *Onchocerca*. Recombinant antigen assays (e.g., LbS2 / LLI-R1) offer higher specificity.
