...
clinical_syndromes:
  ...
  - Genital ulcerative disease (GUD)
endemic_regions:
  - Tropical regions (Caribbean, South America, South-East Asia)
target_organs:
  - Genital tract (genitalia)
  - Myeloid cells (macrophages, neutrophils)
serotypes:
  - N/A
gram_stain: Gram-negative
morphology_shape: Pleomorphic bacilli
key_plasmids:
  - N/A
resistance_genes:
  - N/A
...
*   **Optimal Growth Conditions:** Does not grow in standard culture in the laboratory.
*   **Primary Agar:** N/A
...
*   **Reservoir:** N/A
*   **Transmission Route:** Sexually transmitted.
*   **Endemic Regions & Outbreaks:** Predominantly occurs in tropical regions such as the Caribbean, South America, and South-East Asia. It is a rare disease in the United States.
*   **Public Health & Isolation:** N/A

#### Advanced Laboratory Diagnostics
*   **Direct Visualization & Stains:** Diagnosis relies heavily on the visualization of "Donovan bodies" in tissue smears, impression smears of granulation tissue from genital lesions, or biopsy specimens. These intracellular pleomorphic bacilli are best demonstrated using Giemsa (or modified Giemsa) and Wright's stains.
