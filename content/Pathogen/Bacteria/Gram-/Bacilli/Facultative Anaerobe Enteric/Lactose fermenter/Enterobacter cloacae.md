...
morphology_shape: Short rod (bacillus)
key_plasmids:
  - Plasmids conferring multidrug resistance (including carbapenemases)
resistance_genes:
  - Chromosomal ampC beta-lactamase gene
date: 2026-07-26
draft: false
---
...
*   **Appendages:** Motile (possesses H or flagellar antigens).
*   **Capsule Composition & Structure:** May contain a capsule (K antigen) that produces mucoid colonies.
*   **Spore Characteristics & Germination:** Non-spore-forming.

#### Growth & Biochemical Profile
*   **Optimal Growth Conditions:** Facultative anaerobe. Grows rapidly on standard laboratory culture media.
*   **Primary Agar:** Readily grows on routine bacteriologic media, including MacConkey agar.
*   **Selective / Enriched Agar:** N/A
*   **Metabolic Profile & Biochemical Testing:** Ferments lactose. Catalase-positive, nitrate-positive, and cytochrome oxidase-negative (characteristic of the Enterobacteriaceae family).
...
*   **Immune Evasion Strategies:** The presence of a capsule allows the organism to produce mucoid colonies, providing protection against host phagocytosis.
*   **Host Defense & Immunodeficiency Links:** Functions primarily as an opportunistic pathogen. Disease frequently occurs in hospitalized, debilitated, or immunocompromised patients.

#### Clinical Syndromes
*   **Primary Diseases:** Broad range of hospital-acquired (nosocomial) infections, particularly pneumonia, urinary tract infections, wound infections, and medical device-associated infections.
*   **Secondary, Atypical & Alternate Presentations:** Bacteremia (sepsis) and intraabdominal infections.
*   **Incubation Period:** N/A
*   **Pathognomonic Signs:** N/A
*   **Complications & Sequelae:** N/A

#### Epidemiology & Transmission
*   **Reservoir:** Ubiquitous in the environment (soil, water, and sewage). It also occurs in various foods (e.g., meat, dairy products, and vegetables), hospital environments, and as part of the normal commensal microbiota on the skin and in the intestinal tract of humans and animals.
*   **Transmission Route:** Endogenous spread (migration of normal flora to sterile body sites) or nosocomial transmission via contaminated hospital environments, food, water, or medical equipment.
*   **Endemic Regions & Outbreaks:** Ubiquitous worldwide.
*   **Public Health & Isolation:** Disease control relies on appropriate hospital infection-control practices (e.g., restricting broad-spectrum antibiotic use, proper hand hygiene, and avoiding unnecessary urinary tract catheterization) to reduce the risk of nosocomial transmission.

#### Advanced Laboratory Diagnostics
*   **Direct Visualization & Stains:** Gram stain of clinical specimens reveals short Gram-negative rods.
*   **Molecular Testing:** Enteric multiplex nucleic acid amplification tests (NAATs / PCR) are highly utilized for the rapid detection of the organism and specific resistance markers from clinical specimens.
