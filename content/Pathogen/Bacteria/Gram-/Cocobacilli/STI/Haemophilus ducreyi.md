...
clinical_syndromes:
  ...
  - Inguinal bubo (lymphadenopathy)
endemic_regions:
  - Africa
  - Asia
  - Latin America (historical/endemic regions)
target_organs:
  - Genitourinary tract (genitalia)
  - Regional lymph nodes (inguinal)
serotypes:
  - N/A
gram_stain: Gram-negative
morphology_shape: Small, pleomorphic rod or coccobacillus; characteristically occurs in strands in clinical lesions
key_plasmids:
  - N/A
resistance_genes:
  - N/A
...
*   **Entry & Attachment Mechanism:** Infection is acquired via sexual contact. The bacteria enter microabrasions in the genital epithelium and establish a localized infection.
*   **Intracellular vs Extracellular Survival:** Extracellular. The organisms are typically found in the base of the ulcer, often in association with other pyogenic microorganisms.
*   **Immune Evasion Strategies:** The host immune response is insufficient to confer lasting protection; there is no permanent immunity after a chancroid infection, allowing for repeated reinfections.
...
*   **Reservoir:** Humans.
*   **Transmission Route:** Direct sexual contact.
*   **Endemic Regions & Outbreaks:** Important cause of genital ulcers in Africa and Asia. It is less common in Europe and North America. In the United States, the incidence is cyclic and frequently unrecognized or underreported.
*   **Public Health & Isolation:** Control relies on safe sex practices and the prompt treatment of sexual partners. Clinically, chancroid must be carefully differentiated from syphilis, herpes simplex virus infection, and lymphogranuloma venereum (LGV).

#### Advanced Laboratory Diagnostics
*   **Direct Visualization & Stains:** Gram stain of scrapings from the ulcer base reveals small Gram-negative rods characteristically occurring in strands.
*   **Molecular Testing:** Nucleic acid amplification tests (NAATs / PCR) are significantly more sensitive than culture and are highly recommended due to the difficulty of cultivating the organism in vitro.
