...
clinical_syndromes:
  ...
  - Osteomyelitis
  - Arthropathy
  - Chronic bacteremia with recurrent fevers
endemic_regions:
  - Worldwide
target_organs:
  - Lymph nodes (axillary, epitrochlear, cervical, preauricular)
  - Skin
  - Liver
  - Spleen
...
*   **Cell Wall / Membrane Features:** Possesses a Gram-negative cell wall. It is an aerobic, oxidase-negative, fastidious organism belonging to the α2 subgroup of the class Proteobacteria (family Bartonellaceae).
*   **Appendages:** Appears to lack flagella.
*   **Capsule Composition & Structure:** N/A
*   **Spore Characteristics & Germination:** Non-spore-forming.

#### Growth & Biochemical Profile
*   **Optimal Growth Conditions:** Aerobic, fastidious, and very slow-growing. Recovery in culture requires prolonged incubation (minimum of 3 to 6 weeks) in a humid atmosphere with 5% to 10% CO2 at 35°C to 37°C.
*   **Primary Agar:** Direct culture of biopsy tissue (homogenized in supplemented tissue culture medium) requires fresh chocolate agar or heart infusion agar with 5% rabbit blood. Blood cultures are optimized using the lysis-centrifugation method. Specimens can also be cultured on eukaryotic tissue culture monolayers.
*   **Selective / Enriched Agar:** N/A
*   **Metabolic Profile & Biochemical Testing:** Biochemically relatively inert. It yields negative catalase and oxidase reactions and negative carbohydrate utilization tests. Enzyme activity can be seen with amino acid substrates by testing for preformed enzymes.
...
*   **Enzymes:** N/A
*   **Genetic Elements:** Important diagnostic and phylogenetic target genes include the 16S rDNA gene, the 16S-23S rRNA intergenic spacer region (ITS), the citrate synthase gene (gltA), the 60-kDa heat-shock protein gene (groEL), the pap31 gene, and the cell division protein gene (ftsZ). The ribC gene has the highest discriminatory power for strain differentiation.

#### Pathogenesis & Host Immune Evasion
*   **Entry & Attachment Mechanism:** The organism is transmitted to humans via a cat scratch, lick, or bite, or potentially through the bite or feces of infected cat fleas. Once in the host, it adheres to eukaryotic cells. It is internalized into endothelial cells via an actin-dependent "invasome-mediated" mechanism of cellular invasion.
*   **Intracellular vs Extracellular Survival:** Intracellular. The bacteria multiply and persist within erythrocytes and endothelial cells.
*   **Immune Evasion Strategies:** The organism establishes a long-lasting intra-erythrocytic bacteremia in its feline reservoir. Because the lifespan of infected erythrocytes remains indistinguishable from uninfected erythrocytes, the bacteria are shielded from neutralizing antibodies and immune clearance.
*   **Host Defense & Immunodeficiency Links:** The clinical manifestation is heavily dictated by the host's immune status. In immunocompetent patients, a vigorous cellular immune reaction leads to a localized, self-limited granulomatous or suppurative lymphadenopathy (cat-scratch disease) and the organisms are rapidly cleared from tissues. In severely immunocompromised patients (particularly [[HIV]]/AIDS patients with low CD4 counts), the immune system fails to control the bacteria, resulting in chronic bacteremia and severe, systemic vascular proliferative diseases (bacillary angiomatosis and peliosis hepatis).
...
*   **Transmission Route:** Transmitted between cats by the cat flea (*Ctenocephalides felis*). Transmitted to humans primarily through scratches, bites, or contact with cat saliva. Transmission to humans via the cat flea is suspected but less epidemiologically supported than direct scratches.
