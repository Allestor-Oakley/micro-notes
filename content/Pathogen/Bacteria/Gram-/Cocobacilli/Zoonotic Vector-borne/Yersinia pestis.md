...
morphology_shape: Short, pleomorphic rod or coccobacillus (0.5-0.8 µm wide by 1-3 µm long) exhibiting striking bipolar (safety-pin) staining
key_plasmids:
  - pCD1 plasmid (70 kb; encodes Type III secretion system, Yops, and LcrV)
  - pPCP1 / pPst plasmid (9.5 kb; encodes plasminogen-activating protease)
  - pFra / pMT plasmid (80-101 kb; encodes F1 capsular protein and phospholipase D)
resistance_genes:
  - N/A
date: 2026-07-26
draft: false
...
*   **Cell Wall / Membrane Features:** Possesses a Gram-negative cell wall with lipopolysaccharide (LPS) that has endotoxic activity. It features a type III secretion system consisting of a membrane-spanning complex (a secretion protein F needle) allowing direct injection of proteins into host cells.
*   **Appendages:** Nonmotile.
*   **Capsule Composition & Structure:** Possesses a highly immunogenic protein capsule consisting of the fraction 1 (F1) capsular antigen, which confers antiphagocytic properties and is mainly expressed at 37°C.
*   **Spore Characteristics & Germination:** Non-spore-forming. Extremely susceptible to UV radiation (sunlight) and desiccation, becoming nonviable within 1 hour when released into the environment, though it can survive longer in soil.
...
*   **Exotoxins:**
    ...
    *   **Mechanism of Action:** Effector proteins are injected via the T3SS. YopH dephosphorylates proteins required for phagocytosis; YopE induces cytotoxicity by disrupting actin filaments; and YopJ/P initiates apoptosis in macrophages and suppresses host cytokine production.
...
*   **Intracellular vs Extracellular Survival:** Facultative intracellular. After inoculation, the organisms are phagocytosed; while polymorphonuclear cells kill them, they multiply successfully within macrophages.
...
*   **Reservoir:** Wild and domestic rodents (rats, mice, gerbils, squirrels, prairie dogs, moles). Urban plague is maintained in rat populations, while sylvatic plague affects wild rodents.
*   **Transmission Route:** Bite of infected fleas (primarily the rat flea Xenopsylla cheopis). Direct contact with infected animal tissues or fluids, and inhalation of respiratory aerosols (person-to-person spread occurs in pneumonic plague).
*   **Endemic Regions & Outbreaks:** Found in many parts of the world, specifically in Africa (e.g., Madagascar, which experienced a major urban pneumonic outbreak in 2017), India, Southeast Asia, and the Americas (western United States and Mexico). 95% of current global cases originate from just two countries.
*   **Public Health & Isolation:** Classified as a Category A / Tier 1 potential agent of bioterrorism due to extreme severity and potential for aerosol dissemination. Suspected cases require strict patient isolation. Clinical laboratories must handle cultures with extreme caution (Biosafety Level 3). Health authorities must be notified immediately. Control relies on flea and rodent population management.

#### Advanced Laboratory Diagnostics
*   **Direct Visualization & Stains:** Smears of bubo aspirate, sputum, or blood stained with Wayson, Giemsa, Wright, or methylene blue reveal a striking bipolar ("safety pin") staining pattern. Direct fluorescence assays (DFA) utilizing antibodies against the F1 capsular antigen are highly useful.
*   **Molecular Testing:** Species-specific polymerase chain reaction (PCR) assays on clinical samples (bubo aspirate, sputum, blood, or tissue) are standard.
...
*   **Alternative / Second-Line Treatment:** Doxycycline, ciprofloxacin (or other fluoroquinolones), chloramphenicol, and trimethoprim-sulfamethoxazole.
...
*   **Exceptions to the Rule:** Unlike the other pathogenic Yersinia species (Y. enterocolitica and Y. pseudotuberculosis) which are motile at 25°C and are urease positive, Y. pestis is strictly nonmotile at all temperatures and is urease negative. Furthermore, its virulence is uniquely temperature-regulated between the flea vector (<26°C) and mammalian host (37°C).