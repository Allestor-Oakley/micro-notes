...
clinical_syndromes:
  ...
  - Septic syndrome (in immunocompromised patients)
endemic_regions:
  - North America (primarily Southeast, South-central, Midwest, and coastal Atlantic United States)
  - South America
  - Asia
target_organs:
  - Bloodstream
  - Circulating leukocytes (specifically monocytes and mononuclear phagocytes)
serotypes:
  - N/A
gram_stain: Gram-negative (but stains poorly due to lack of peptidoglycan)
...
*   **Cell Wall / Membrane Features:** Possesses a Gram-negative cell wall structure but uniquely lacks both peptidoglycan and lipopolysaccharide (LPS). The cell wall is notably rich in cholesterol, which is derived from the host cell and is critical for the bacterium's survival and entry into mammalian cells.
*   **Appendages:** N/A
*   **Capsule Composition & Structure:** N/A
*   **Spore Characteristics & Germination:** Non-spore-forming.

#### Growth & Biochemical Profile
*   **Optimal Growth Conditions:** Obligate intracellular bacterium. It infects and multiplies within the membrane-bound compartments (phagocytic vacuoles) of host mononuclear phagocytes, forming microcolonies known as morulae (derived from the Latin word for mulberry).
*   **Primary Agar:** Cannot be cultivated on cell-free artificial agar media. It requires cell culture techniques for growth.
*   **Selective / Enriched Agar:** N/A
*   **Metabolic Profile & Biochemical Testing:** Unlike chlamydiae, it is capable of synthesizing its own adenosine triphosphate (ATP).
...
*   **Endotoxins & Superantigens:** Lacks the genes required for lipid A biosynthesis; therefore, it does not possess traditional Gram-negative endotoxin (LPS).
*   **Enzymes:** N/A
*   **Genetic Elements:** Taxonomically classified in the family Anaplasmataceae within the order Rickettsiales. Based on 16S ribosomal RNA and groESL sequence comparisons, it shares a common ancestor with other obligate intracellular pathogens such as Wolbachia, Neorickettsia, Orientia, and Rickettsia.
...
#### Clinical Syndromes
*   **Primary Diseases:** Human monocytic ehrlichiosis (HME). Typically presents 1 to 2 weeks after a tick bite as a nonspecific flulike illness characterized by high fever, headache, malaise, and myalgias.
*   **Secondary, Atypical & Alternate Presentations:** Asymptomatic infections can occur.
*   **Incubation Period:** 7 to 14 days following exposure.
*   **Pathognomonic Signs:** A late-onset maculopapular rash develops in 30% to 40% of patients, which is notably more common in children than in adults.
*   **Complications & Sequelae:** The majority of patients develop leukopenia, thrombocytopenia, and elevated serum transaminases. While the overall mortality rate is relatively low (2% to 3%), the disease can be severe; more than half of symptomatic patients require hospitalization and experience a prolonged recovery period.

#### Epidemiology & Transmission
*   **Reservoir:** The primary reservoir is the persistently infected white-tailed deer (Odocoileus virginianus). Domestic dogs, foxes, coyotes, and wolves can also serve as reservoir hosts. Humans are considered accidental, dead-end hosts.
*   **Transmission Route:** Zoonotic transmission occurs exclusively through the bite of an infected tick. The principal vector is the lone-star tick (Amblyomma americanum). Other ticks, including Ixodes pacificus, Ixodes ricinus, Haemaphysalis yeni, Amblyomma testudinarium, Amblyomma maculatum, and Dermacentor variabilis, may play a limited role in transmission.
*   **Endemic Regions & Outbreaks:** Found in North America, South America, and Asia. In the United States, disease is highly prevalent in the Southeast, South-central, Midwest (Missouri, Arkansas, Oklahoma), and coastal Atlantic states (Maryland, Virginia, New Jersey, New York), directly matching the geographic distribution of the lone-star tick.
