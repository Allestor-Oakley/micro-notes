...
target_organs:
  ...
  - Liver
serotypes:
  - 13 known serovars (based on O and H antigens)
  - Serotype 1/2a
  - Serotype 1/2b
  - Serotype 4b
gram_stain:
  - Gram-positive
morphology_shape:
  - Short (0.4 to 0.5 × 0.5 to 2 μm), thin, uniform, nonbranching rods appearing singly, in pairs, or in short chains
key_plasmids:
  - N/A
resistance_genes:
  - N/A
...
*   **Cell Wall / Membrane Features:** Gram-positive cell envelope with a uniform rod shape.
*   **Appendages:** Motile, exhibiting a characteristic end-over-end tumbling motility at room temperature but less so at 37°C. Uses the host cell's actin machinery to form "actin rockets" or filopods for intracellular movement.
*   **Capsule Composition & Structure:** N/A
*   **Spore Characteristics & Germination:** Non-spore-forming.

#### Growth & Biochemical Profile
*   **Optimal Growth Conditions:** Facultatively anaerobic. Capable of growth over a broad temperature range (1°C to 45°C), including robust survival and multiplication at refrigerator temperatures (4°C). Tolerates conditions of low pH and high salt concentrations.
*   **Primary Agar:** Sheep blood agar, on which it characteristically exhibits weak β-hemolysis.
*   **Selective / Enriched Agar:** Cold enrichment (storage of the specimen in the refrigerator at 4°C for a prolonged period) and selective media are utilized to isolate listeriae in specimens heavily contaminated with rapidly growing flora.
*   **Metabolic Profile & Biochemical Testing:** Catalase-positive.

#### Virulence Factors & Genetics
*   **Secretion Systems:** N/A
*   **Exotoxins:**
    *   **Toxin Name:** Listeriolysin O
    *   **Mechanism of Action:** A pore-forming cytolysin that is activated by the acidic pH of the phagolysosome. It lyses the phagolysosome membrane, allowing the bacteria to escape the vesicle and enter the host cell's cytoplasm.
*   **Endotoxins & Superantigens:** N/A
*   **Enzymes:** Two distinct phospholipases are produced, which act synergistically with listeriolysin O to lyse the phagolysosome membrane.
...
*   **Intracellular vs Extracellular Survival:** Facultative intracellular pathogen capable of replicating in the cytoplasm of epithelial cells, [[Monocyte and Macrophage|macrophages]], and hepatocytes.
...
*   **Complications & Sequelae:** Intrauterine fetal death, spontaneous abortion, and severe neurologic deficits following meningoencephalitis.

#### Epidemiology & Transmission
*   **Reservoir:** Ubiquitous in soil, water, groundwater, and vegetation. Found in the feces of mammals, birds, fish, and other animals. Causes asymptomatic gastrointestinal carriage in 1% to 5% of healthy humans.
*   **Transmission Route:** Ingestion of contaminated food products (e.g., unpasteurized milk, soft cheeses, raw vegetables like cabbage, and processed meats/cold cuts). Transmitted vertically from mother to child in utero or during birth.
*   **Endemic Regions & Outbreaks:** Distributed worldwide with no seasonal incidence limit. Frequently responsible for large, multistate foodborne outbreaks (e.g., associated with processed turkey, chicken, or bologna) because it overcomes standard food preservation barriers by growing at cold temperatures.
