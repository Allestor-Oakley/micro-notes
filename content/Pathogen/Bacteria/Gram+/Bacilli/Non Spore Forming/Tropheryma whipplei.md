...
clinical_syndromes:
  - Whipple disease (malabsorption disease)
  - Fever
  - Abdominal pain
  - Diarrhea
  - Weight loss
...
target_organs:
  ...
  - Eyes (ophthalmic tissue)
serotypes:
  - N/A
gram_stain: Gram-positive
morphology_shape: Bacilli (rod-shaped)
key_plasmids:
  - N/A
resistance_genes:
  - N/A
...
*   **Cell Wall / Membrane Features:** Characterized as a Gram-positive actinomycete. The organism and its associated glycoprotein deposition stain strongly with the periodic acid-Schiff (PAS) stain.
*   **Appendages:** N/A
...
*   **Enzymes:** N/A
*   **Genetic Elements:** Phylogenetic analysis based on polymerase chain reaction (PCR) amplification of its 16S ribosomal RNA genes revealed that the organism is an actinomycete not closely related to any other known bacterial genus.
