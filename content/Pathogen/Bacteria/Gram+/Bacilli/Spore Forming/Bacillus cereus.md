...
clinical_syndromes:
  ...
  - Ocular infections (keratitis, conjunctivitis)
  - Catheter-associated sepsis
  - Transfusion-associated sepsis
  - Meningitis
  - Endocarditis
  - Acute gastroenteritis
  - Severe pneumonia (anthrax-like disease)
endemic_regions:
...
gram_stain:
  - Gram-positive
morphology_shape:
  - Large rods arranged in chains
key_plasmids:
  - Plasmids encoding preformed cyclic peptide (emetic toxin)
  - Plasmids containing Bacillus anthracis toxin genes (in specific severe pneumonia strains)
resistance_genes:
  - N/A
date: 2026-07-25
draft: false
...
*   **Spore Characteristics & Germination:** Endospore-forming bacteria. Under a Gram stain, the unstained spores appear as distinct clear areas inside the Gram-positive rods. Spores are capable of surviving harsh conditions such as cooking temperatures.

#### Growth & Biochemical Profile
*   **Optimal Growth Conditions:** Rapid growth.
*   **Primary Agar:** Produces colonies with a characteristic distinct morphology featuring a dull or frosted-glass ("waxen" or "wax-colored") surface, which is the historical derivation of the name *cereus*.
...
*   **Exotoxins:**
    ...
    *   **Toxin Name:** Cereolysin and Phospholipase C (Necrotic toxin)
...
*   **Immune Evasion Strategies:** Spore formation enables the bacteria to survive extreme environmental conditions, such as cooking. Spores can germinate in slowly cooling foods (like large quantities of rice), allowing vegetative cells to multiply and produce toxin during log-phase growth or during sporulation.
*   **Host Defense & Immunodeficiency Links:** Commonly an opportunistic pathogen. Systemic or invasive infections (such as meningitis, endocarditis, and bacteremia/sepsis) occur most frequently in immunocompromised hosts, individuals receiving intravenous injections, or patients with catheters.

#### Clinical Syndromes
*   **Primary Diseases:**
    *   **Food Poisoning (Emetic Form):** Often associated with fried rice, milk, and pasta. Characterized by nausea, vomiting, and abdominal cramps; diarrhea is occasional. It is an intoxication (due to preformed cyclic peptide) rather than an infection. Generally self-limiting with recovery within 24 hours.
...
*   **Transmission Route:** Ingestion of contaminated food, traumatic inoculation (e.g., eye injuries), intravenous drug use, or contaminated medical/transfusion equipment.
*   **Endemic Regions & Outbreaks:** Worldwide (ubiquitous).
*   **Public Health & Isolation:** N/A

#### Advanced Laboratory Diagnostics
*   **Direct Visualization & Stains:** Gram-stain reveals large Gram-positive rods; spores may be seen as clear, unstained areas within the vegetative cells in cultures, though they are rarely seen in direct clinical specimens.
*   **Molecular Testing:** N/A
*   **Serology & Immunology:** N/A
*   **Diagnostic Nuances:** Isolation of *B. cereus* from stool is not diagnostic on its own, as it can be part of the normal human flora. For food poisoning, a concentration of $\ge 10^5$ bacteria per gram of the implicated food is considered diagnostic. Extraintestinal infections are diagnosed by isolating the organism from nonfecal specimens, such as blood, wound exudate, or eye aspirates.
