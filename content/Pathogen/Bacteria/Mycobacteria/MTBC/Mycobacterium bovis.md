...
*   **Immune Evasion Strategies:** The hydrophobic lipid cell wall and clumped growth protect the organism from chemical agents, drying, and host immune protections. Once phagocytized by host [[Monocyte and Macrophage|macrophages]], it prevents phagolysosome fusion to replicate intracellularly.
*   **Host Defense & Immunodeficiency Links:** Control and clearance of the infection depend on a [[T-Cell|T-cell]]-mediated cellular immune response (delayed-type hypersensitivity). Activated [[Monocyte and Macrophage|macrophages]] present antigens to CD4+ and CD8+ [[T-Cell|T cells]], which release interferon-gamma and other cytokines to enhance [[Monocyte and Macrophage]] bactericidal activity. The host cellular response attempts to contain the infection by forming concentric granulomas with a central necrotic core (caseous necrosis) surrounded by multinucleated giant cells, [[Monocyte and Macrophage|monocytes]], histiocytes, and an outer ring of fibrosis. Immunocompromised hosts, particularly those with CD4+ [[T-Cell|T-cell]] deficiencies (such as [[HIV]]/AIDS patients), are unable to clear or contain the mycobacteria, leading to rapid progression and disseminated disease.
